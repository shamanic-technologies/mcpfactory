...
const SITE_NAME = "AI Cold Email Automation | MCP Factory";
const SITE_DESCRIPTION = "Launch AI-powered cold email campaigns in minutes. Find leads, generate personalized emails, send at scale, and optimize automatically. Works with ChatGPT, Claude, and Cursor.";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: "AI Cold Email Automation - Launch Campaigns in Minutes | MCP Factory",
    template: "%s | AI Cold Email",
  },
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: SITE_NAME,
    title: "AI Cold Email Automation - Launch Campaigns in Minutes",
    description: "Find leads, generate personalized emails, send at scale. All powered by AI.",
    images: [
      {
        url: "https://mcpfactory.org/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "AI Cold Email Automation",
      },
    ],
  },
  twitter: {
...
const softwareJsonLd = {
  ...
  name: "MCP Factory Cold Email",
  applicationCategory: "BusinessApplication",
  applicationSubCategory: "Email Marketing Software",
  operatingSystem: "Web",
  description: "AI-powered cold email automation platform. Launch personalized cold email campaigns from ChatGPT, Claude, or Cursor.",
  url: SITE_URL,
  offers: [
    {
      "@type": "Offer",
